...
if(isset($_POST['name']) && isset($_POST['F_email'])){
	...
	if($conn->connect_error){
		...
		$stmt = $conn->prepare("insert into facultysinging(name , F_email, F_Id) values(?, ?, ?)");
...
<form action="" method="post">
      ...
      <h2>FACULTY SINGING</h2>
      <p>Please fill in this form to register for faculty singing.</p>
